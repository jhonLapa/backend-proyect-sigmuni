...
namespace Jca.Sigmuni.Infraestructure.Repositories.TramiteDocumentario.Implementations
{
    public class RangoRepository : IRangoRepository
    {
        ...
        private readonly IPaginator<Rango> _paginator;

        public RangoRepository(ApplicationDbContext context, IPaginator<Rango> paginator)
        {
            _context = context;
            _paginator = paginator;
        }

        public async Task<IList<Rango>> findAll()
        => await _context.Rangos
